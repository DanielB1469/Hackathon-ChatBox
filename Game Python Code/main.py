...
def draw_health_bars(screen, player, opponent):
    """Draws health bars for player and opponent"""
    pygame.draw.rect(screen, (255, 0, 0), (50, 30, 200, 20))  # Player health background
    pygame.draw.rect(screen, (0, 255, 0), (50, 30, 200 * (player.health / player.max_health), 20))  # Player health

    pygame.draw.rect(screen, (255, 0, 0), (550, 30, 200, 20))  # Opponent health background
    pygame.draw.rect(screen, (0, 255, 0), (550, 30, 200 * (opponent.health / opponent.max_health), 20))  # Opponent health
...
while running:
    ...
    # **Game Playing**
        ...
        # ✅ Draw health bars
        draw_health_bars(screen, player, opponent)
